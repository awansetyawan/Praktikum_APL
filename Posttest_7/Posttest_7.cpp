...
void tambah_data(){
    Game_file.open("Data_Posttest_7.txt", ios::app);
...
void pindah_data(){
    ...
    Game_file.open("Data_Posttest_7.txt", ios::in);
...
void openfile(){
    ...
    if (!Game_file.is_open()){
        Game_file.open("Data_Posttest_7.txt", ios::out | ios::trunc);
        Game_file.close();
    }
    Game_file.close();
}
...
void updatefile(){
    Game_file.open("Data_Posttest_7.txt", ios::out);
